...
class FavoriteCityLocalDataSourceImplTest {
    ...
    private lateinit var favoriteCityLocalDataSource: FavoriteCityLocalDataSourceImpl
    ...
    fun setup() {
        ...
        favoriteCityLocalDataSource = FavoriteCityLocalDataSourceImpl(favoriteCityDao)
    }
